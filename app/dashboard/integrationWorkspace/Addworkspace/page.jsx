...
/* ─── EyeInput — kept local (same pattern as Platform2Page's PasswordInput) */
...
/* ─── SubSectionHeader — kept local (mirrors Platform2Page's SubSectionHeader) */
...
/* ═══════════════════════════════════════════════════════════════════════════
   MAIN COMPONENT — all state & logic identical to original
═══════════════════════════════════════════════════════════════════════════ */
export default function SettingsPage() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (response.ok && result.success) {
        ...
        //router.push(`/dashboard/integrationWorkspace/Transcription/${platformId}?appid=${appId}`);
        router.push(
          `/dashboard/integrationWorkspace/column-mapping/${platformId}?appid=${appId}`,
        );
        setToast(true);
  ...
  const handleReset = () => {
    setForm({
      instance: "", orgId: "", tokenUrl: "", clientId: "", clientSecret: "",
    ...
    setSendFileChannel("");
    setBucketRegion(""); setBucketName(""); setAccessKey(""); setSecretKey(""); setStorageClass("");
    setSftpServerName(""); setSftpBaseFolder(""); setSftpUserId(""); setSftpPassword(""); setSftpSshKey("");
    setGcpBucket(""); setGcpProjectId(""); setGcpServiceKey("");
    setAzureAccount(""); setAzureContainer("");
    setErrors({});
  };
      ...
      <main className="flex-1 p-4">
        <div className="mx-auto w-full max-w-[1220px] overflow-hidden rounded-2xl border border-[#d7e1f0] bg-white shadow-[0_14px_36px_rgba(17,39,82,0.10)]">
          ...
          <div className="border-b border-[#eef3f8] bg-[linear-gradient(180deg,#fcfdff_0%,#f4f8fd_100%)] px-6 py-4">
            <p className="text-[12px] font-extrabold uppercase tracking-[0.12em] text-[var(--brand-primary)]">Integration Configuration</p>
            <p className="mt-1 text-[12px] text-[#64748b]">Manage app credentials, OAuth tokens, and system preferences.</p>
          </div>
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              ...
              <div>
                ...
                {frequencyLoading ? (
                  ...
                  <Select
                    placeholder="Failed to load frequency"
                    value=""
                    onChange={() => { }}
                    options={[]}
                  />
              ...
              <div>
                ...
                {timezonesLoading ? (
                  ...
                  <Select
                    placeholder="Failed to load timezones"
                    value=""
                    onChange={() => { }}
                    options={[]}
                  />
                ...
                <div className="md:col-span-2 mt-2 rounded-xl border border-[#d7e1f0] bg-[#f8fbff] p-4">
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    <Input
                      ...
                      value={gcpBucket}
                      onChange={(e) => {
                        setGcpBucket(e.target.value);
                        setErrors(p => ({ ...p, gcpBucket: !e.target.value ? "Required" : "" }));
                      }}
                    />
                    ...
                    <Input
                      ...
                      onChange={(e) => {
                        ...
                        setErrors(p => ({ ...p, gcpProjectId: !e.target.value ? "Required" : "" }));
                      }}
                    />
                    <div>
                      <EyeInput
                        ...
                        value={gcpServiceKey}
                        onChange={(e) => {
                          setGcpServiceKey(e.target.value);
                          setErrors(p => ({ ...p, gcpServiceKey: !e.target.value ? "Required" : "" }));
                        }} />
                    </div>
                    {/* <div className="md:col-span-2">
                      <textarea
                ...
                <div className="md:col-span-2 mt-2 rounded-xl border border-[#d7e1f0] bg-[#f8fbff] p-4">
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    <Input
                      ...
                      value={azureAccount}
                      onChange={(e) => {
                        setAzureAccount(e.target.value);
                        setErrors(p => ({ ...p, azureAccount: !e.target.value ? "Required" : "" }));
                      }}
                    />
                    ...
                    <Input
                      ...
                      onChange={(e) => {
                        setAzureContainer(e.target.value);
                        setErrors(p => ({ ...p, azureContainer: !e.target.value ? "Required" : "" }));
                      }}
                    />
                    ...
                    <div className="md:col-span-2">
                      <EyeInput
                        ...
                        onChange={(e) => {
                          setAzureConnection(e.target.value);
                          setErrors(p => ({ ...p, azureConnection: !e.target.value ? "Required" : "" }));
                        }}
                        show={showToken}
                        onToggle={() => setShowToken(!showToken)}
                      />
